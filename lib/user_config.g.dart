...
_UserConfig _$UserConfigFromJson(Map<String, dynamic> json) => _UserConfig(
  ...
  reminderNotificationTime: const TimeOfDayConverter().fromJson(
    json['reminderNotificationTime'] as String?,
  ),
  timetableNotificationTime: const TimeOfDayConverter().fromJson(
    json['timetableNotificationTime'] as String?,
  ),
  timetableNotificationId: (json['timetableNotificationId'] as num?)?.toInt(),
  ...
  digestiveNotifications:
      (json['digestiveNotifications'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
);

Map<String, dynamic> _$UserConfigToJson(
  _UserConfig instance,
) => <String, dynamic>{
  'schemaVersion': instance.schemaVersion,
  'reminderNotificationTime': const TimeOfDayConverter().toJson(
    instance.reminderNotificationTime,
  ),
  'timetableNotificationTime': const TimeOfDayConverter().toJson(
    instance.timetableNotificationTime,
  ),
  'timetableNotificationId': instance.timetableNotificationId,
  'digestiveNotificationTimeBefore': instance.digestiveNotificationTimeBefore,
