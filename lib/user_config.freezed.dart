...
mixin _$UserConfig {
  ...
  Timestamp? get lastChanged;
  @TimeOfDayConverter()
  TimeOfDay? get reminderNotificationTime;
  @TimeOfDayConverter()
  TimeOfDay? get timetableNotificationTime;
  int? get timetableNotificationId;
  int? get digestiveNotificationTimeBefore;
  TimetableConfig? get timetable;
  List<String> get digestiveNotifications;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(
                    other.reminderNotificationTime, reminderNotificationTime) ||
                other.reminderNotificationTime == reminderNotificationTime) &&
            (identical(other.timetableNotificationTime,
                    timetableNotificationTime) ||
                other.timetableNotificationTime == timetableNotificationTime) &&
            (identical(
                    other.timetableNotificationId, timetableNotificationId) ||
                other.timetableNotificationId == timetableNotificationId) &&
            (identical(other.digestiveNotificationTimeBefore,
                    digestiveNotificationTimeBefore) ||
                other.digestiveNotificationTimeBefore ==
                    digestiveNotificationTimeBefore) &&
            (identical(other.timetable, timetable) ||
                other.timetable == timetable) &&
            const DeepCollectionEquality()
                .equals(other.digestiveNotifications, digestiveNotifications));
  }
  ...
  int get hashCode => Object.hash(
      ...
      digestiveNotificationTimeBefore,
      timetable,
      const DeepCollectionEquality().hash(digestiveNotifications));
...
class _$UserConfigCopyWithImpl<$Res> implements $UserConfigCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? reminderNotificationTime = freezed,
    Object? timetableNotificationTime = freezed,
    Object? timetableNotificationId = freezed,
    Object? digestiveNotificationTimeBefore = freezed,
    Object? timetable = freezed,
    Object? digestiveNotifications = null,
  }) {
    return _then(_self.copyWith(
      ...
      lastChanged: freezed == lastChanged
          ...
          : lastChanged // ignore: cast_nullable_to_non_nullable
              as Timestamp?,
      reminderNotificationTime: freezed == reminderNotificationTime
          ? _self.reminderNotificationTime
          : reminderNotificationTime // ignore: cast_nullable_to_non_nullable
              as TimeOfDay?,
      timetableNotificationTime: freezed == timetableNotificationTime
          ? _self.timetableNotificationTime
          : timetableNotificationTime // ignore: cast_nullable_to_non_nullable
              as TimeOfDay?,
      timetableNotificationId: freezed == timetableNotificationId
          ? _self.timetableNotificationId
          : timetableNotificationId // ignore: cast_nullable_to_non_nullable
              as int?,
      digestiveNotificationTimeBefore: freezed ==
              digestiveNotificationTimeBefore
          ? _self.digestiveNotificationTimeBefore
          : digestiveNotificationTimeBefore // ignore: cast_nullable_to_non_nullable
              as int?,
      timetable: freezed == timetable
          ? _self.timetable
          : timetable // ignore: cast_nullable_to_non_nullable
              as TimetableConfig?,
      digestiveNotifications: null == digestiveNotifications
          ? _self.digestiveNotifications
          : digestiveNotifications // ignore: cast_nullable_to_non_nullable
              as List<String>,
    ));
  }
...
class _UserConfig implements UserConfig {
  const _UserConfig(
      {this.schemaVersion,
      @JsonKey(includeFromJson: false, includeToJson: false) this.lastChanged,
      @TimeOfDayConverter() this.reminderNotificationTime,
      @TimeOfDayConverter() this.timetableNotificationTime,
      this.timetableNotificationId,
      this.digestiveNotificationTimeBefore,
      this.timetable,
      final List<String> digestiveNotifications = const []})
      : _digestiveNotifications = digestiveNotifications;
...
// ignore: invalid_annotation_target
  ...
  @override
  @TimeOfDayConverter()
  final TimeOfDay? reminderNotificationTime;
  @override
  @TimeOfDayConverter()
  final TimeOfDay? timetableNotificationTime;
  @override
  final int? timetableNotificationId;
  @override
  final int? digestiveNotificationTimeBefore;
  @override
  ...
  @JsonKey()
  List<String> get digestiveNotifications {
    if (_digestiveNotifications is EqualUnmodifiableListView)
      return _digestiveNotifications;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
                other._digestiveNotifications, _digestiveNotifications));
  }
  ...
  int get hashCode => Object.hash(
      ...
      digestiveNotificationTimeBefore,
      timetable,
      const DeepCollectionEquality().hash(_digestiveNotifications));
...
mixin _$TimetableConfig {
  bool? get showSaturday;
  int? get periodCountToDisplay;
  ...
  $TimetableConfigCopyWith<TimetableConfig> get copyWith =>
      _$TimetableConfigCopyWithImpl<TimetableConfig>(
          this as TimetableConfig, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TimetableConfig &&
            (identical(other.showSaturday, showSaturday) ||
                other.showSaturday == showSaturday) &&
            (identical(other.periodCountToDisplay, periodCountToDisplay) ||
                other.periodCountToDisplay == periodCountToDisplay));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, showSaturday, periodCountToDisplay);
...
abstract mixin class $TimetableConfigCopyWith<$Res> {
  factory $TimetableConfigCopyWith(
          TimetableConfig value, $Res Function(TimetableConfig) _then) =
      _$TimetableConfigCopyWithImpl;
  @useResult
  $Res call({bool? showSaturday, int? periodCountToDisplay});
}
...
class _$TimetableConfigCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? showSaturday = freezed,
    Object? periodCountToDisplay = freezed,
  }) {
    return _then(_self.copyWith(
      showSaturday: freezed == showSaturday
          ? _self.showSaturday
          : showSaturday // ignore: cast_nullable_to_non_nullable
              as bool?,
      periodCountToDisplay: freezed == periodCountToDisplay
          ? _self.periodCountToDisplay
          : periodCountToDisplay // ignore: cast_nullable_to_non_nullable
              as int?,
    ));
  }
}
...
class _TimetableConfig implements TimetableConfig {
  ...
  @override
  final int? periodCountToDisplay;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TimetableConfigCopyWith<_TimetableConfig> get copyWith =>
      __$TimetableConfigCopyWithImpl<_TimetableConfig>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TimetableConfigToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$TimetableConfigCopyWith<$Res>
    implements $TimetableConfigCopyWith<$Res> {
  factory _$TimetableConfigCopyWith(
          _TimetableConfig value, $Res Function(_TimetableConfig) _then) =
      __$TimetableConfigCopyWithImpl;
  @override
  @useResult
  $Res call({bool? showSaturday, int? periodCountToDisplay});
}
