...
class LinkWithGoogleTasksPage extends StatefulWidget {
  const LinkWithGoogleTasksPage({Key? key}) : super(key: key);

  @override
  State<LinkWithGoogleTasksPage> createState() =>
      _LinkWithGoogleTasksPageState();
}

class _LinkWithGoogleTasksPageState extends State<LinkWithGoogleTasksPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Google Tasksと連携'),
      ),
