...
private object PigeonsPigeonUtils {
...
data class NotificationPermissionStateWrapper (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as NotificationPermissionStateWrapper
    return PigeonsPigeonUtils.deepEquals(this.value, other.value)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + PigeonsPigeonUtils.deepHash(this.value)
    return result
  }
}
        ...
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.getToken{ result: Result<String> ->
              ...
              if (error != null) {
                reply.reply(PigeonsPigeonUtils.wrapError(error))
              } else {
                val data = result.getOrNull()
                reply.reply(PigeonsPigeonUtils.wrapResult(data))
              }
            }
          }
        } else {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val wrapped: List<Any?> = try {
              ...
              PigeonsPigeonUtils.wrapError(exception)
            }
            reply.reply(wrapped)
          }
        } else {
